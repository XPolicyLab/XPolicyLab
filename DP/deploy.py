...
def eval_one_episode_batch(TASK_ENV, model_client):
    ...
    while not TASK_ENV.is_episode_end(): # Check whether the episode ends
        ...
        obs_list = TASK_ENV.get_obs(env_idx_list) # Get Observation

        model_client.call(func_name="update_obs", obs=obs_list)  # Update Observation, `update_obs` here can be modified
        ...
        '''
            [
                [action0, aciton1, action2], # env 0 actions
                [action0, aciton1, action2], # env 1 actions
                # ...
            ]
        '''