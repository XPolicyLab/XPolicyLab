...
# Wait for the port instead of sleeping: this checkpoint took 942 s to load from a cold page
# cache, and the environment client gives up after 900 s. The helper also fails fast if the
# server dies. Budget 1800 s; a warm start still connects in well under three minutes.
