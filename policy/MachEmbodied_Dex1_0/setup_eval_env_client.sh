...
action_type=${5}; seed=${6}; env_gpu_id=${7}; eval_env_conda_env=${8}
additional_info=${9}; policy_server_port=${10}; policy_server_ip=${11:-localhost}
...
bash "${UTILS_DIR}/setup_env_client.sh" "${UTILS_DIR}" "${SCRIPT_DIR}/deploy.yml" \
