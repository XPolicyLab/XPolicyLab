...
SmolVLA 基于 LeRobot SmolVLA 接入 XPolicyLab，当前主要用于 ALOHA/双臂 joint action 训练与推理。
...
```text
policy/SmolVLA/checkpoints/<dataset_name>-<ckpt_name>-<env_cfg_type>-<expert_data_num>-<action_type>-<seed>
```
