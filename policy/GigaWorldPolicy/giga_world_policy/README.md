...
This package contains the GigaWorldPolicy model, LeRobot v2.1 dataset loader, XPolicyLab/RoboDojo training config, and training utilities used by `policy/GigaWorldPolicy/train.sh`.
...
- RoboDojo inference utilities: `experiment/robodojo/inference_server.py`
...
GIGAWORLD_DATA_DIR=/path/to/lerobot GIGAWORLD_NUM_FRAMES=28 WANDB_MODE=online GIGAWORLD_WANDB_PROJECT=gwp-robodojo bash train.sh RoboDojo_lerobot_v21_video stack_bowls arx_x5 100 joint 930 0,1,2,3,4,5,6,7
```
