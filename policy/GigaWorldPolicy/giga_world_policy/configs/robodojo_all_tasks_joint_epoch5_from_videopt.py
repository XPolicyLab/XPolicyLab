...
# All-task joint fine-tuning initialized from the completed all-task video-pt
...
config["wandb"]["project"] = os.environ.get("GIGAWORLD_WANDB_PROJECT", "gwp-robodojo")
config["wandb"]["name"] = os.environ.get("GIGAWORLD_WANDB_NAME", "all_tasks_joint5ep_from_videopt")
