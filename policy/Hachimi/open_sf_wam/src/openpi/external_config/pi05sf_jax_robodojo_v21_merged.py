# Additive copy of pi05sf_jax_robodojo_v21_offcache pointing at the MERGED dataset
# (3500 released episodes + new general_pickup episodes with per-episode
# instructions). Separate asset_id so norm_stats.json never collides with the
# file the running job 344555 reads.
import os
...
my_config = TrainConfig(
    name="pi05sf_jax_robodojo_v21_merged",
