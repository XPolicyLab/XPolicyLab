...
Self-contained, **eval-only** SIPAI memory policy for XPolicyLab. This directory
...
- `model.safetensors`: FP32 inference weights.
- `tokenizer.model`: SentencePiece tokenizer.

Download the current weights from
...
device: cuda:0
exec_chunk_size: 10
architecture: sipai_pi05_memory_joint_v1
dtype: float32
history_frames: 25
history_interval: 20
history_pool_size: 4
...
4 by 4 pooled history token grid, FP32 compute, and 10 flow integration steps.
