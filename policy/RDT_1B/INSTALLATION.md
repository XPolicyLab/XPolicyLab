...
| action_type | `joint` |
| xspark 权重 | `/mnt/xspark-data/final_ckpt/RDT_1B/RoboDojo_sim_seed_0` |
...
```bash
# terminal 1 — server
bash setup_eval_policy_server.sh RoboDojo stack_bowls RoboDojo_sim_seed_0 arx_x5 3500 joint 0 0 RDT <port> localhost
