...
# HoloBrain eval — XPolicyLab 11-arg contract (see XPolicyLab/README.md).
#
# Usage:
...
#
# Example (debug wiring):
#   bash eval.sh test_data arx_x5 arx_x5 arx_x5 3 joint 0 0 0 holobrain XPolicyLab
...
policy_gpu_id=${8:-0}
env_gpu_id=${9:-0}
policy_conda_env=${10:?policy_conda_env required}
