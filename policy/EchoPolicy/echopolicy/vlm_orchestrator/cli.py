...
"""Minimal command-line entry point for the EchoPolicy proxy."""
...
from vlm_orchestrator.proxy import (
    OrchestratorProxy,
    ProxyConfig,
)
...
from vlm_orchestrator.vlm import GoogleVLM, PassthroughVLM

def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="EchoPolicy proxy with pluggable transforms"
    )
    ...
    parser.add_argument("--vlm-model", default=os.environ.get("VLM_MODEL", "gemini-3.8-flash"))
    parser.add_argument(
        "--vlm-base-url",
        default=os.environ.get("VLM_BASE_URL", "https://generativelanguage.googleapis.com/v1beta"),
    )
    ...
    parser.add_argument(
        ...
        default=os.environ.get("VLM_THINKING_LEVEL", "medium"),
