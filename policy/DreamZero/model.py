...
DEFAULT_MODEL_PATH = Path("/mnt/pfs/pg4hw0/qiwei/models/checkpoints/DreamZero-AgiBot")
DEFAULT_TOKENIZER_PATH = DREAMZERO_DIR / "checkpoints" / "umt5-xxl"
...
def _resolve_model_path(model_cfg: dict[str, Any]) -> Path:
    explicit = model_cfg.get("model_path")
    if explicit:
