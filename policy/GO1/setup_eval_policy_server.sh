...
# echo "[SERVER] policy=${policy_name}, task=${task_name}, port=${policy_server_port}, host=${policy_server_host}, action_dim=${action_dim}"
# if [ -n "${MODEL_PATH:-}" ]; then
#     echo "[SERVER] model_path=${MODEL_PATH}"
# else
#     echo "[SERVER] model_path=<auto-resolve from checkpoints>"
...
#     OVERRIDES+=(data_stats_path="${DATA_STATS_PATH}")
