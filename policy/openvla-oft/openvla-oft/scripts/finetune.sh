...
torchrun --standalone --nnodes 1 --nproc-per-node 4 vla-scripts/finetune.py \
  ...
  --run_id_note "4gpu--cuda0123--3img--proprio--film" # you can change the wandb_project and run_id_note according to your preference for logging the finetuning runs in Weights & Biases.
